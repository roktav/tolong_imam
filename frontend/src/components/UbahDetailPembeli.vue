            ...
            <v-form ref="form" @submit.prevent="submit" style="margin-left: 17%; margin-top: 4%">
                <v-container grid-list-xl fluid>
                    ...
                    <v-layout wrap>
                        ...
                        <v-flex xs6>
                            <v-text-field
                                    v-model="detailPembeli.password"
    ...
    export default {
        ...
        methods: {
            ...
            ubahPembeli(){
                ...
                axios.post('http://localhost:8080/pembeli/detail-pembeli/ubah-detail-pembeli/' + this.$route.params.id_user, this.detailPembeli)
            },
            resetForm () {
                this.detailPembeli = Object.assign({}, this.defaultForm);
        ...
        mounted(){
            axios.get('http://localhost:8080/pembeli/detail-pembeli/' + this.$route.params.id_user)
                .then(response => {
                    ...
                    console.log(this.detailPembeli)
                    this.namaPembeli = this.detailPembeli.nama;
                })
                .catch(e => {
                    console.log(e)
                })
